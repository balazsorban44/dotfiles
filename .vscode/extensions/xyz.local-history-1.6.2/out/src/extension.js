...
const historyContent_provider_1 = require("./historyContent.provider");
...
function activate(context) {
    ...
    const contentProvider = new historyContent_provider_1.default(controller);
    context.subscriptions.push(vscode.workspace.registerTextDocumentContentProvider(historyContent_provider_1.default.scheme, contentProvider));
